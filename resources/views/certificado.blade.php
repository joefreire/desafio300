    ...
    <center>
        <div style="width:800px; height:600px; padding:20px; text-align:center; border: 10px solid #787878">
            <div style="width:750px; height:550px; padding:20px; text-align:center; border: 5px solid #787878">
               ...
               ">
               <br><br>
               <span style="font-size:25px">Certifico que o Atleta</span>
               <br><br>

               <span style="font-size:30px"><b>{{$nome}}</b></span><br/><br/>
               <span style="font-size:25px">completou o desafio </span> <br/><br/>
               <span style="font-size:30px">{{$userDesafio->desafio->nome}}</span> <br/><br/>
               <br>
